@push('product')
  ...
  <title>{{substr($productt->name, 0,11)."-"}}</title>
@endpush  
  ...
  <div class="container">
    ...
    <div class="col-lg-9">
              ...
              <div class="right-area">
                ...
                <div class="product-price">
                    <p class="title">{{ $langg->lang87 }} :</p>
                      <p class="price pr-2"><span id="sizeprice">{{ $productt->showPrice() }}</span>
                        <small><del>{{ $productt->showPreviousPrice() }}</del></small></p><br>
                        {{-- Credit Section start  --}}
                         @if($productt->showPrice()>=400)
                            <div class="container p-3  rounded" style="border:1px dashed rgba(0, 0, 0, 0.3);">
                                <p class="title  pt-2 mr-1" >В рассрочку на:</p>
                                ...
                                <p class="title pt-2 d-none" id="commission"></p><br>
                                <p class="title pt-2 d-none" id="prepayment">Предоплата :</p>
                                <p class="title pt-2 d-none" id="monthly_payment"></p>
                          </div><br>
                          @endif
                          {{-- Credit section end --}}
                  </div>
      ...
      {{-- PRODUCT REPORT SECTION --}}
                   ...
                   {{-- <div class="pt-3 ">
                     <button type="button" class="btn btn-danger  badge-pill pt-1 pb-1 px-3">Подписаться</button>
                   </div> --}}
                              ...
                              <li>
                                <div class="single-review">
                                  <div class="left-area">
                                    ...
                                    <p class="date">
                                      {{ Carbon\Carbon::parse($review->review_date)->formatLocalized('%d, %B %Y') }}
                                      {{-- Carbon\Carbon::parse($user->date1) --}}
                                    </p>
                                  </div>
                                  <div class="right-area">
    ...
    <div class="col-lg-3">
    {{-- Quantity of sold product   start--}}
