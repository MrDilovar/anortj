				...
				<i class="icofont-upload-alt"></i> {{ $langg->lang643 }}
						                    ...
						                    <div class="{{ !empty($data->whole_sell_qty) ? "":"showbox" }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" step="any" type="text" class="input-field price_mask" placeholder="{{ $langg->lang666 }}" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="any" type="text" class="input-field price_mask" placeholder="{{ $langg->lang666 }}" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
