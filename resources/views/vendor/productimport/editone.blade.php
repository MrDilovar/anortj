				...
				<i class="icofont-upload-alt"></i> {{ $langg->lang643 }}
											  ...
											  <div id="f-link" {!! !filter_var($data->photo,FILTER_VALIDATE_URL) ? 'style="display:none"' : '' !!}>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" step="any" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="any" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
