                                                        ...
                                                        {{-- <div class="invoice__metaInfo">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @if($order->method=="Installments")
                                                                        <p>{{ $langg->lang294 }} {{__("В рассрочку")}}</p>
                                                                        <p>{{ __("Предоплата")}} : (10%) {{$order->installments_prepay}}{{$order->currency_sign}}</p>
                                                                        <p>{{ __("Ежемесячный платеж")}} : {{$order->installments_month_pay}}{{$order->currency_sign}}  ({{$order->installments_for}} мес.)</p>
                                                                        @else
                                                                        <p>{{ $langg->lang293 }} {{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value , 2) }}</p>
                                                                        <p>{{ $langg->lang294 }} {{$order->method}}</p>
                                                                    @endif        
