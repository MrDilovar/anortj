                            ...
                            <div class="billing-add-area">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>{{ $langg->lang798 }}:
                                             {!! $order->payment_status == 'Unpaid' ? "<span class='badge badge-danger'>". $langg->lang799 ."</span>":"<span class='badge badge-success'>". $langg->lang800 ."</span>" !!}
                                        </p>
                            ...
                            <div class="shipping-add-area">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pt-4">
                                        ...
                                        @endphp
                                        <address>
                                            {{ __('Дата доставки') }}: {{$order->shipping_date}}<br>
                                            @if($d_time[0] =='during')
                                           {{ __('Время доставки') }}: {{__('В течении дня')}}</span><br>
                                            @else
                                            {{ __('Время доставки') }}: c {{$d_time[0]}} до {{$d_time[1]}}</span><br>
                                             @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if($order->method=="Installments")
                                            <p>{{ $langg->lang294 }} {{__("В расррочку")}}</p>
                                            
                                            <p>{{ __("Предоплата : ") }} (10 %) {{$order->currency_sign}}{{$order->installments_prepay}}</p>
                                    <p>{{ __("Ежемесячный платеж :") }} {{$order->currency_sign}}{{$order->installments_month_pay}}  ({{$order->installments_for}} мес.) </p>
                                        @else
                                            <p>{{ $langg->lang293 }}
