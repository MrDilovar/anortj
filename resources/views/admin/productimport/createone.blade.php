				...
				<i class="icofont-upload-alt"></i> {{ __("Upload Image Here") }}
											  ...
											  <div id="f-link" style="display: none;">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" step="any" type="number" class="input-field" placeholder="{{ __("e.g 20") }}" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="any" type="number" class="input-field" placeholder="{{ __("e.g 20") }}" min="0">
													</div>
												</div>
