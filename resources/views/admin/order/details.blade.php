                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                <tbody>
                                                <tr>
                                                    <th class="45%" width="45%">{{ __('ID Заказа') }}</th>
                                                    <td width="10%">:</td>
                                                    <td class="45%" width="45%">{{$order->order_number}}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Количество товаров') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->totalQty}}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Итого') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ $order->pay_amount }}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Дата заказа') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{date('d-M-Y H:i:s a',strtotime($order->created_at))}}</td>
                                                </tr>
                                                @if($order->method=="Installments")
                                                    <tr>
                                                        <th width="45%">{{ __('Способ Оплаты') }}</th>
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{__('В расрочку')}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th width="45%">{{ __('Предоплата (10%)') }}</th>
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{$order->currency_sign}}{{$order->installments_prepay}}</td>
                                                    </tr> 
                                                     @else 
                                                    <tr>
                                                        <th width="45%">{{ __('Способ Оплаты') }}</th>
                                                ...
                                                @endif
                                                    @if($order->method=="Installments")
                                                        <tr>
                                                            <th width="45%">{{ __('Срок ') }}{{$order->installments_for}} мес.</th>
                                                            <td width="10%">:</td>
                                                            <td width="45%">{{$order->currency_sign}}{{$order->installments_month_pay}}</td>
                                                        </tr>
                                                    @else
                                                        <tr>
                                                ...
                                                @endif
                                                    ...
                                                    <th width="10%">:</th>
                                                    <td width="45%">{!! $order->payment_status == 'Unpaid' ? "<span class='badge badge-danger'>Unpaid</span>":"<span class='badge badge-success'>Paid</span>" !!}</td>
