...
@section('content')
                        ...
                        @include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product Sku') }}" name="sku" required="" value="{{ str_random(3).substr(time(), 6,8).str_random(3) }}" readonly>
				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
						                    ...
						                    <div class="showbox">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" type="text" class="input-field price_mask" placeholder="{{ __('e.g 20') }}" step="any" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="any" type="text" class="input-field price_mask" placeholder="{{ __('e.g 20') }}" min="0">
													</div>
												</div>
											...
											<div class="showbox">
												...
												<div class="row">
						                          ...
						                          <div class="row">
						                            ...
						                            <div class="col-lg-7">
						                              <div class="text-editor">
						                                <textarea name="meta_description" class="input-field" placeholder="{{ __('Meta Description') }}" required></textarea>
						                              </div>
						                            </div>
						                          </div>
