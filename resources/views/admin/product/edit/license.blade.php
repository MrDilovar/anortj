			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> {{ __("Upload Image Here") }}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" type="text" class="input-field price_mask" placeholder="{{ __("e.g 20") }}" step="any" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="any" type="text" class="input-field price_mask" placeholder="{{ __("e.g 20") }}" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
