					...
					<div class="body-area">
					  ...
					  <form id="geniusform" action="{{route('admin-prod-update',$data->id)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input type="text" class="input-field" placeholder="{{ __('Enter Product Sku') }}" name="sku" required="" value="{{ $data->sku }}" readonly>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input name="price" type="text" class="input-field price_mask" placeholder="e.g 20" step="any" min="0" value="{{round($data->price * $sign->value , 2)}}" required="">
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-7">
									<input name="previous_price" step="any" type="text" class="input-field price_mask" placeholder="e.g 20" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
								</div>
							</div>
