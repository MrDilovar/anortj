	...
	<div class="modal fade" id="deactivated-product" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header d-block text-center">
					<h4 class="modal-title d-inline-block">{{ __("Deactivate Product") }}</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				...
				<!-- Modal body -->
				<div class="modal-body">
					<textarea class="form-control" name="issue_deactivate"  rows="2" cols=50  placeholder="Напишите причину..."></textarea>
				</div>

				<!-- Modal footer -->
				<div class="modal-footer justify-content-center">
					<button type="button" class="btn btn-default" data-dismiss="modal">{{ __("Cancel") }}</button>
					<a class="btn btn-danger btn-ok" data-dismiss="modal">Deactivate</a>
				</div>

			</div>
		</div>
	</div>
	{{-- ISSUE DEACTIVATED PRODUCT ENDS	--}}
