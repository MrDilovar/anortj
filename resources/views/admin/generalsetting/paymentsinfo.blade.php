                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="action-list">
                                                            <select class="process select droplinks {{ $gs->is_kmilli == 1 ? 'drop-success' : 'drop-danger' }}">
                                                              <option data-val="1" value="{{route('admin-gs-kmilli',1)}}" {{ $gs->is_kmilli == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                              <option data-val="0" value="{{route('admin-gs-kmilli',0)}}" {{ $gs->is_kmilli == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                                            </select>
                                                          </div>
                                                    </div>
                                                  </div>
                                                ...
                                                <div class="row justify-content-center">
                                                  <div class="col-lg-3">
                                                    <div class="left-area">
                                                        <h4 class="heading">{{ __('Korti Milli Key') }} *
                                                          </h4>
                                                    </div>
                                                  </div>
                                                  <div class="col-lg-6">
                                                    <input type="text" class="input-field" placeholder="{{ __('Korti Milli Key') }}" name="kmilli_key" value="{{ $gs->kmilli_key }}" required="">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                  <div class="col-lg-3">
                                                    <div class="left-area">
                                                        <h4 class="heading">{{ __('Korti Milli User Name') }} *
                                                          </h4>
                                                    </div>
                                                  </div>
                                                  <div class="col-lg-6">
                                                    <input type="text" class="input-field" placeholder="{{ __('Korti Milli User Name') }}" name="kmilli_user_name" value="{{ $gs->kmilli_user_name }}" required="">
                                                  </div>
                                                </div>
                        ...
                        <!------------------------- Korti Milli  End--------------------------->
                          ...
                          <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="action-list">
                                                            <select class="process select droplinks {{ $gs->is_payler == 1 ? 'drop-success' : 'drop-danger' }}">
                                                              <option data-val="1" value="{{route('admin-gs-payler',1)}}" {{ $gs->is_payler == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                              <option data-val="0" value="{{route('admin-gs-payler',0)}}" {{ $gs->is_payler == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                                            </select>
                                                          </div>
                                                    </div>
                                                  </div>
                                                ...
                                                <div class="row justify-content-center">
                                                  <div class="col-lg-3">
                                                    <div class="left-area">
                                                        <h4 class="heading">{{ __('Payler Key') }} *
                                                          </h4>
                                                    </div>
                                                  </div>
                                                  <div class="col-lg-6">
                                                    <input type="text" class="input-field" placeholder="{{ __('Payler Key') }}" name="payler_key" value="{{ $gs->payler_key }}" required="">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                  <div class="col-lg-3">
                                                    <div class="left-area">
                                                        <h4 class="heading">{{ __('Payler Password') }} *
                                                          </h4>
                                                    </div>
                                                  </div>
                                                  <div class="col-lg-6">
                                                    <input type="text" class="input-field" placeholder="{{ __('Payler Key Password') }}" name="payler_password" value="{{ $gs->payler_password }}" >
                                                  </div>
                                                </div>
                        ...
                        <!--------------- Installments (Рассрочка)  Start------------------->
                             <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                  <h4 class="heading">
                                      {{ __('Installments (Рассрочка)') }}
                                  </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="action-list">
                                      <select class="process select droplinks {{ $gs->is_installments == 1 ? 'drop-success' : 'drop-danger' }}">
                                        <option data-val="1" value="{{route('admin-gs-installments',1)}}" {{ $gs->is_installments == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                        <option data-val="0" value="{{route('admin-gs-installments',0)}}" {{ $gs->is_installments == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                      </select>
                                    </div>
                              </div>
                            </div>
                          ...
                          <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                  <h4 class="heading">{{ __('Сommission % ') }} *
                                    </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <input type="text" class="input-field" placeholder="{{ __('Ввидети коммисию') }}" name="installments_fee" value="{{ $gs->installments_fee }}" required="">
                            </div>
                          </div>
                          <hr>
                       <!--------------- Installments (Рассрочка)  End------------------->
