                      ...
                      <form id="geniusformdata" action="{{route('admin-subcat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __("Meta Keys") }} *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="meta_keys" placeholder="{{ __("Enter Meta Keys") }}" required value="{{$data->meta_keys}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="meta_description" placeholder="{{ __("Enter Meta Description") }}" required value="{{$data->meta_description}}">
                          </div>
                        </div>
