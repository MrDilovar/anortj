                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="meta_keys" placeholder="{{ __('Enter Meta Keywords') }}" value="{{$data->meta_keys}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="meta_description" placeholder="{{ __('Enter Meta Description') }}" value="{{$data->meta_description}}">
                          </div>
                        </div>
