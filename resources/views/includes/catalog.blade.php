                ...
                <div class="body-area">
                  <form id="catalogForm" action="{{ route('front.category', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')]) }}" method="GET">
                    ...
                    <div class="price-range-block">
                        ...
                        <div class="livecount">
                        <input type="text" min=0  name="min"  id="min_price" class="price-range-field" value="{{ App\Models\Product::all()->pluck('price')->min()}}" />
                          <span>{{$langg->lang62}}</span>
                          <input type="text" min=0  name="max" id="max_price" class="price-range-field" value="{{ App\Models\Product::all()->pluck('price')->max()}}" />
                        </div>
                      </div>
