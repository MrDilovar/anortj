<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-prod-active') }}"><span>{{ __('Activated Product') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-waiting') }}"><span>{{ __('Waiting Product') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-change') }}"><span>{{ __('Changed Product') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-deactive') }}"><span>{{ __('Deactivated Product') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-discount') }}"><span>{{ __('Успей купить') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-featured') }}"><span>{{ __('Стоит приглядеться') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-catalog-index') }}"><span>{{ __('Product Catalogs') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-report-index') }}"><span>{{ __('Отчетность') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-prod-report-moderator-index') }}"><span>{{ __('Активность модераторов') }}</span></a>
            </li>
        </ul>
    </li>
