...
<head>
	...
	<meta name="yandex-verification" content="90659ee5ead0e179" />
	<meta name="yandex-verification" content="c75820611a3d13db" />
 ...
 {{-- 	@if(isset($seo) && !empty($seo->meta_keys) && !empty($seo->meta_description))
	    <meta name="keywords" content="{{ $seo->meta_keys }}">
		<meta name="description" content="{{ $seo->meta_description }}">
	    <meta name="author" content="Anor">
	 
   @elseif(isset($page->meta_tag) && isset($page->meta_description))
       ...
       @elseif(isset($blog->meta_tag) && isset($blog->meta_description))
		...
		<title>{{$gs->title}}</title>  
		@elseif(isset($subcat) && !empty($subcat->meta_keys))
    ...
    @elseif(isset($productt) &&  !empty($productt->meta_tag) && !empty($productt->meta_description) )
...
<noscript>
<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5DDVB5Q" height="0" width="0" style="display:none;visibility:hidden"></iframe>
</noscript>
						...
						<div class="left-content">
							<div class="list">
								<ul>
									...
									@if($gs->is_language == 1)
									<li>
										<div class="language-selector pt-1">
									...
									@if($gs->is_currency == 1)
									<li>
										<div class="currency-selector pt-1">
								<span>{{ Session::has('currency') ?   DB::table('currencies')->where('id','=',Session::get('currency'))->first()->sign   : DB::table('currencies')->where('is_default','=',1)->first()->sign }}</span>
									...
									<a href="#">
										<li class="text-light font-weight-bold">
											<img src="{{asset('assets/images/sale.png')}}" class="img-fluid" style="width:30px" alt="Responsive image"> 
						...
						<div class="right-content">
							<div class="list">
								<ul>
									...
									<li class="login">
										<a href="{{ route('user.login').'?s_id=sign' }}"  class="sign-log">
											<span class="sign-in links">{{ $langg->lang12 }}</span> 
										</a>
										{{-- <span class="links">|</span>
										<a href="{{ route('user.login').'?s_id=join' }}"  class="sign-log">
											<span class="join links">{{ $langg->lang13 }}</span>
										</a> --}}
									</li>
									@else
			...
			<div class="row align-items-center mainmenu-area-innner">
				<div class="col-lg-3 col-md-6 categorimenu-wrapper remove-padding">
					...
					<div class="categories_menu">
						<div class="categories_title " style="margin-top:-1px">
							<h2 class="categori_toggle"><i class="fa fa-bars"></i> <a href="/category" class="text-white"> {{ $langg->lang14 }}</a> <i class="fa fa-angle-down arrow-down"></i></h2>
						</div>
							...
							<ul>
								...
								@endif
									...
									@if( $category->id==50)
										...
										<ul class="{{ $ck == 1 ? 'categories_mega_menu' : 'categories_mega_menu column_1' }} h-auto" >
												...
												@if(count($subcat->childs) > 0)
													<div class="categorie_sub_menu">
														<ul>
															...
															<li><a href="{{ route('front.childcat',['slug1' => $childcat->subcategory->category->slug, 'slug2' => $childcat->subcategory->slug, 'slug3' => $childcat->slug]) }}">{{ucfirst($childcat->name)}}</a></li>
															@endforeach
														</ul>
													</div>
												@endif
	...
	<footer class="footer" id="footer">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-4">
					...
					<div class="fotter-social-links">
						<ul>
									  ...
									  @if(App\Models\Socialsetting::find(1)->inst_status == 1)
										<li>
									 ...
									 @if(App\Models\Socialsetting::find(1)->tel_status == 1)
										<li>
											<a href="{{ App\Models\Socialsetting::find(1)->telegram }}" class="telegram" target="_blank">
									...
									@if(App\Models\Socialsetting::find(1)->f_status == 1)
										<li>
											<a href="{{ App\Models\Socialsetting::find(1)->whats_up }}" class="facebook" target="_blank">
										...
										@if(App\Models\Socialsetting::find(1)->f_status == 1)
										<li>
											<a href="{{ App\Models\Socialsetting::find(1)->viber }}" class="facebook" target="_blank">
						...
						<ul class="link-list">
							...
							<li>
								<a href="{{ route('front.partnerset') }}">
									<i class="fas fa-angle-double-right"></i>{{  __('Как начать продавать') }}
								</a>
							</li>
							<li>
								<a href="{{ route('front.oplatainfo') }}">
									<i class="fas fa-angle-double-right"></i>{{  __('Оплата и доставка') }}
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="pt-2">
					<img src="{{asset('assets/front/images/korti-milli-logo.png')}}" alt="Korti milli Logo" class="img-responsive w-50" />
				</div>
				{{-- <div class="col-md-6 col-lg-4">
								...
								<div class="login-form signin-form">
									...
									<form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
										...
										<div class="form-input">
											<input type="text" name="phone" maxlength="9" placeholder="{{ __('Введите номер телефона')}}"
												required="">
				        ...
				        <div class="login-area">
				          <div class="login-form signin-form">
				            ...
				            <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
				              {{ csrf_field() }}
				              <div class="form-input">
				                <input type="text" name="phone" placeholder="{{ $langg->lang184 }}" required="">
				                <i class="icofont-phone"></i>
				              </div>
				              <div class="form-input">
				              ...
				              <div class="form-forgot-pass">
				                ...
				                <div class="right">
								  ...
								  <a href="{{route('user-forgot')}}" id="show-forgot1">
                       ...
                       @include('includes.admin.form-login')
                        <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
						  ...
						  <div class="col-lg-6 pr-0">
								<div class="form-input ">
									<input type="text" class="User Name" name="country_code" placeholder="" value="+992"required="" readonly>
									<i class="icofont-phone"></i>
								</div>
...
<script type="text/javascript">
  ...
  var langg    = {!! json_encode($langg) !!};
	...
	<!-- Product page  custom credit functional -->
	<script src="{{asset('assets/front/js/custom-credit.js')}}"></script>
	
	<!-- SMS Js-->
	<script src="{{asset('assets/vendor/js/sms/verification.js')}}"></script>
