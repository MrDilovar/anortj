...
Route::prefix('admin')->group(function() {
 ...
 Route::get('/products/report-moderator/datatables', 'Admin\ProductController@datatablesReportModerator')->name('admin-prod-report-moderator-datatables'); //JSON REQUEST
 Route::get('/products/report-moderator', 'Admin\ProductController@indexReportModerator')->name('admin-prod-report-moderator-index');
  ...
  Route::get('/products/active/datatables', 'Admin\ProductController@activedatatables')->name('admin-prod-active-datatables'); //JSON REQUEST
  Route::get('/products/active', 'Admin\ProductController@active')->name('admin-prod-active');
  Route::get('/products/waiting/datatables', 'Admin\ProductController@waitingdatatables')->name('admin-prod-waiting-datatables'); //JSON REQUEST
  Route::get('/products/waiting', 'Admin\ProductController@waiting')->name('admin-prod-waiting');
  Route::get('/products/change/datatables', 'Admin\ProductController@changedatatables')->name('admin-prod-change-datatables'); //JSON REQUEST
  Route::get('/products/change', 'Admin\ProductController@change')->name('admin-prod-change');

  Route::get('/products/discount/datatables', 'Admin\ProductController@discountdatatables')->name('admin-prod-discount-datatables'); //JSON REQUEST
  Route::get('/products/discount', 'Admin\ProductController@discount')->name('admin-prod-discount');

  Route::get('/products/featured/datatables', 'Admin\ProductController@featureddatatables')->name('admin-prod-featured-datatables'); //JSON REQUEST
  Route::get('/products/featured', 'Admin\ProductController@featured')->name('admin-prod-featured');
...
// Verification Section Ends
  ...
  Route::get('/category/moveCategoriesToSubCategories', 'Admin\CategoryController@moveCategoriesToSubCategories')->name('admin-cat-move');
...
// Payment Informations
  ...
  Route::get('/general-settings/kmilli/{status}', 'Admin\GeneralSettingController@kmilli')->name('admin-gs-kmilli');
  Route::get('/general-settings/payler/{status}', 'Admin\GeneralSettingController@payler')->name('admin-gs-payler');
  Route::get('/general-settings/installments/{status}', 'Admin\GeneralSettingController@installments')->name('admin-gs-installments');
...
// ------------ GLOBAL ----------------------
  ...
  Route::post('/products/status/deactivate/{id1}/{id2}', 'Admin\ProductController@status_deactivate')->name('admin-prod-status-deactivate');
  // STATUS SECTION ENDS
...
Route::prefix('user')->group(function() {
  ...
  Route::post('/otplogin', 'User\LoginController@otp_login')->name('user.loginotp.submit');
  // User Login End
  ...
  Route::post('/otp', 'User\OtpController@mVerify')->name('otp.send');
  // User Register End
  ...
  Route::post('/otpforgot', 'User\ForgotController@mForgot')->name('user-forgot-submit');
  // User Forgot Ends
...
// User order cansel
  Route::get('/order/{id}', 'User\OrderController@order')->name('user-order');
  Route::post('/order/{id}/cancel', 'User\OrderController@order_cancel')->name('user-order-cancel');
...
// ************************************ FRONT SECTION **********************************************
 ...
 // PARTNER SETI SECTION
  Route::get('/partnerset','Front\FrontendController@partnerset')->name('front.partnerset');
  // PARTNER SETI SECTION ENDS

   // Oplata i Dostavka info SECTION
   Route::get('/oplatainfo','Front\FrontendController@oplatainfo')->name('front.oplatainfo');
   // Oplata i Dostavka info SECTION ENDS
  ...
  // Korti Milli Routes  
  Route::post('/kmilli/submit', 'Front\KortiMilliController@store')->name('kmilli.submit');
  Route::get('/kmilli/notify', 'Front\KortiMilliController@paykmilliCallback')->name('kmilli.notify');

  // Payler  Routes  
  Route::post('/payler/submit', 'Front\PaylerController@store')->name('payler.submit');
  Route::get('/payler/notify', 'Front\PaylerController@payPaylerCallback')->name('payler.notify');

  // Installments (Рассрочка) Routes   
  Route::post('/installments/submit', 'Front\InstallmentsController@store')->name('installments.submit');
  Route::get('/installments/notify', 'Front\InstallmentsController@notify')->name('installments.notify');
