...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $top_category = Category::top_products();
        
        $sliders = DB::table('sliders')->get();
        $top_small_banners = DB::table('banners')->where('type','=','TopSmall')->get();
        $ps = DB::table('pagesettings')->find(1);
        $feature_products =  Product::where('featured','=',1)->where('status','=',1)->orderByRaw("RAND()")->take(4)->get();
        //$feature_products =  Product::where('featured','=',1)->where('ordered_count','!=','NULL')->where('status','=',1)->orderBy('ordered_count','desc')->take(8)->get();
        // Product::where('ordered_count','!=','NULL')->where('status','=',1)->orderBy('id','desc')->take(9)->get();
	    return view('front.index',compact('ps','sliders','top_small_banners','feature_products', 'top_category'));
	}
    ...
    public function extraIndex()
    {
        ...
        $discount_products =  Product::where('is_discount','=',1)->where('status','=',1)->where('discount_date','>',date('m/d/Y'))->orderByRaw("RAND()")->take(4)->get();
        $best_products = Product::where('best','=',1)->where('status','=',1)->orderBy('id','desc')->take(6)->get();
        // $top_products = Product::where('top','=',1)->where('status','=',1)->orderByRaw("RAND()")->take(4)->get();
        $top_products = Product::where('ordered_count','!=','NULL')->where('status','=',1)->orderBy('ordered_count','desc')->take(8)->get();
        ...
        $hot_products =  Product::where('ordered_count','!=','NULL')->where('status','=',1)->orderBy('ordered_count','desc')->take(9)->get();
        // dd( $hot_products);
        // $latest_products =  Product::where('latest','=',1)->where('status','=',1)->orderBy('id','desc')->take(9)->get();
        $latest_products =  Product::where('status','=',1)->latest()->orderBy('id','desc')->take(9)->get();
        //$trending_products =  Product::where('trending','=',1)->where('status','=',1)->orderBy('id','desc')->take(9)->get();          
        $trending_products =  Product::where('status','=',1)->orderBy('views','desc')->take(9)->get();            
    ...
    public function partnerset(){
        return view('front.partnerset');
    }

     public function oplatainfo(){
        return view('front.oplatainfo');
    }
...
// CURRENCY SECTION ENDS
    ...
    public function autosearch($slug)
    {
        if(strlen($slug) > 1){
            $search = ' '.$slug;
            $prods = Product::where('name', 'like', $slug . '%')->where('status','=',1)->take(10)->get();
...
// -------------------------------- PAGE SECTION ----------------------------------------
    public function page($slug)
    {
        ...
        if(empty($page))
        {
            ...
            return view('errors.404',compact('top_products'));
        }
