        ...
        elseif($status == 'declined') {
         ...
         return Datatables::of($datas)
                            ...
                            ->editColumn('pay_amount', function(Order $data) {
                                ...
                                return  $data->pay_amount .' '. $data->currency_sign;
                            })
                            ->editColumn('pay_method', function(Order $data) {
                               
                                return  $data->method;
                            })
                            ->editColumn('pay_status', function(Order $data) {
                               if($data->payment_status=='Unpaid') return  "<span class='badge badge-danger'>$data->payment_status</span>";
                               if($data->payment_status=='Paid') return  "<span class='badge badge-success'>$data->payment_status</span>";
                            })
                            ...
                            ->rawColumns(['id','action','pay_status'])
